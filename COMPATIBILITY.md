...
| --- | --- | --- | --- |
| v3 (current) | v2.3.5 | 0.16.21 | Same formula syntax and KaTeX behavior as v2.3.4; ordinary DOM scanning is restricted to assistant messages, so user-authored LaTeX stays source text. |
