...
| --- | --- | --- | --- |
| v5 (current) | v2.3.5 | 0.16.21 | v4 plus a hard brace-transport rule: ordinary visible set braces are always `\lbrace ... \rbrace`; `\left`/`\right` brace forms are prohibited because Markdown can strip `\{` / `\}` before KaTeX receives the source. |
