...
| --- | --- | --- | --- |
| v4 (current) | v2.3.5 | 0.16.21 | v3 plus a hard three-line block-math transport invariant: one complete equation source line between `$$` delimiters, so Markdown cannot consume standalone equalities before KaTeX receives them. |
